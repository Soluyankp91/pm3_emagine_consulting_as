...
export class WorkflowPeriodComponent extends AppComponentBase implements OnInit, OnDestroy {
	...
	// 								? this.mapConsultantAnchors(SalesPlaceholderConsultantAnchors, index)
	// 								: this.mapConsultantAnchors(SalesConsultantDataSections, index),
	// 						anchorsOpened: false,
	// 					});
	// 				});
	// 			}
	...
	// 									item.employmentType === EmploymentTypes.FeeOnly ||
	// 									item.employmentType === EmploymentTypes.Recruitment
    //                                         ? this.mapConsultantAnchors(ContractPlaceholderConsultantAnchors, index)
    //                                         : this.mapConsultantAnchors(ContractConsultantDataSections, index),
	// 								anchorsOpened: false,
	// 							};
	// 						});
