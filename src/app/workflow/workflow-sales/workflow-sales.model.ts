...
export class WorkflowSalesMainForm extends UntypedFormGroup {
	constructor() {
		super({
			...
			salesAccountManagerIdValue: new UntypedFormControl(null, [
				Validators.required,
...
export class WorkflowSalesClientDataForm extends UntypedFormGroup {
	constructor() {
		super({
			...
			directClientIdValue: new UntypedFormControl(null, [
				Validators.required,
				CustomValidators.autocompleteValidator(['clientId']),
			]),
			...
			invoicePaperworkContactIdValue: new UntypedFormControl(null, [
				Validators.required,
				CustomValidators.autocompleteValidator(['id']),
			]),
