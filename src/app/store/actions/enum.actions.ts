...
export const loadSaleTypesSuccess = createAction(
	'[Enums] Load Sale Types Success',
	props<{ salesTypes: EnumEntityTypeDto[] }>()
);
...
export const loadDiscountsSuccess = createAction(
	'[Enums] Load Discounts Success',
	props<{ discounts: EnumEntityTypeDto[] }>()
);
...
export const loadMarginsSuccess = createAction(
	'[Enums] Load Margins Success',
	props<{ margins: EnumEntityTypeDto[] }>()
);
