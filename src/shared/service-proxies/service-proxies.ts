...
export class ClientPeriodServiceProxy {
     ...
     * @return Success
     */
    clientContractsGet(clientPeriodId: string): Observable<ClientPeriodContractsDataWithReadonlyDto> {
        let url_ = this.baseUrl + "/api/ClientPeriod/{clientPeriodId}/client-contracts";
        if (clientPeriodId === undefined || clientPeriodId === null)
            throw new Error("The parameter 'clientPeriodId' must be defined.");
        url_ = url_.replace("{clientPeriodId}", encodeURIComponent("" + clientPeriodId));
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ClientPeriodContractsDataWithReadonlyDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ClientPeriodContractsDataWithReadonlyDto>;
        }));
    }

    protected processClientContractsGet(response: HttpResponseBase): Observable<ClientPeriodContractsDataWithReadonlyDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ClientPeriodContractsDataWithReadonlyDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ClientPeriodContractsDataWithReadonlyDto>(null as any);
    }
...
export class ConsultantPeriodServiceProxy {
     ...
     * @return Success
     */
    consultantContractsGet(consultantPeriodId: string): Observable<ConsultantPeriodContractsDataWithReadonlyDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ConsultantPeriodContractsDataWithReadonlyDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ConsultantPeriodContractsDataWithReadonlyDto>;
        }));
    }

    protected processConsultantContractsGet(response: HttpResponseBase): Observable<ConsultantPeriodContractsDataWithReadonlyDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ConsultantPeriodContractsDataWithReadonlyDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ConsultantPeriodContractsDataWithReadonlyDto>(null as any);
    }
...
export class ClientPeriodContractsDataWithReadonlyDto implements IClientPeriodContractsDataWithReadonlyDto {
    mainData?: ContractsMainDataDto;
    clientData?: ContractsClientDataDto;
    consultantData?: ConsultantContractsDataDto[] | undefined;
    contractLinesDoneManuallyInOldPm?: boolean | undefined;
    ...
    constructor(data?: IClientPeriodContractsDataWithReadonlyDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ClientPeriodContractsDataWithReadonlyDto {
        data = typeof data === 'object' ? data : {};
        let result = new ClientPeriodContractsDataWithReadonlyDto();
        result.init(data);
        return result;
    }
...
export interface IClientPeriodContractsDataWithReadonlyDto {
    mainData?: ContractsMainDataDto;
    clientData?: ContractsClientDataDto;
    consultantData?: ConsultantContractsDataDto[] | undefined;
    contractLinesDoneManuallyInOldPm?: boolean | undefined;
...
export class ConsultantPeriodContractsDataWithReadonlyDto implements IConsultantPeriodContractsDataWithReadonlyDto {
    remarks?: string | undefined;
    noRemarks?: boolean;
    projectDescription?: string | undefined;
    mainData?: ContractsMainDataDto;
    ...
    constructor(data?: IConsultantPeriodContractsDataWithReadonlyDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ConsultantPeriodContractsDataWithReadonlyDto {
        data = typeof data === 'object' ? data : {};
        let result = new ConsultantPeriodContractsDataWithReadonlyDto();
        result.init(data);
        return result;
    }
...
export interface IConsultantPeriodContractsDataWithReadonlyDto {
    remarks?: string | undefined;
    noRemarks?: boolean;
    projectDescription?: string | undefined;
    mainData?: ContractsMainDataDto;
