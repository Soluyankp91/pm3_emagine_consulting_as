...
export class SalesServiceProxy {
     ...
     * @return Success
     */
    editFinishPost1(clientPeriodId: string, body?: ClientPeriodSalesDataDto | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processEditFinishPost1(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditFinishPost1(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processEditFinishPost1(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    editFinishPost2(consultantPeriodId: string, body?: ConsultantPeriodSalesDataDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/ConsultantPeriod/{consultantPeriodId}/sales/edit-finish";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processEditFinishPost2(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditFinishPost2(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processEditFinishPost2(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class ContractsServiceProxy {
     ...
     * @return Success
     */
    editFinishPost3(clientPeriodId: string, body?: ClientPeriodContractsDataDto | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processEditFinishPost3(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditFinishPost3(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processEditFinishPost3(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    editFinishPost4(consultantPeriodId: string, body?: ConsultantPeriodContractsDataDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/ConsultantPeriod/{consultantPeriodId}/contracts/edit-finish";
        if (consultantPeriodId === undefined || consultantPeriodId === null)
            throw new Error("The parameter 'consultantPeriodId' must be defined.");
        url_ = url_.replace("{consultantPeriodId}", encodeURIComponent("" + consultantPeriodId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processEditFinishPost4(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditFinishPost4(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processEditFinishPost4(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class ConsultantPeriodServiceProxy {
     ...
     * @return Success
     */
    salesGet(consultantPeriodId: string): Observable<ConsultantPeriodSalesDataDto> {
        let url_ = this.baseUrl + "/api/ConsultantPeriod/{consultantPeriodId}/sales";
        if (consultantPeriodId === undefined || consultantPeriodId === null)
            throw new Error("The parameter 'consultantPeriodId' must be defined.");
        url_ = url_.replace("{consultantPeriodId}", encodeURIComponent("" + consultantPeriodId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSalesGet(response: HttpResponseBase): Observable<ConsultantPeriodSalesDataDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    salesPut(consultantPeriodId: string, body?: ConsultantPeriodSalesDataDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/ConsultantPeriod/{consultantPeriodId}/sales";
        if (consultantPeriodId === undefined || consultantPeriodId === null)
            throw new Error("The parameter 'consultantPeriodId' must be defined.");
        url_ = url_.replace("{consultantPeriodId}", encodeURIComponent("" + consultantPeriodId));
     ...
     * @return Success
     */
    contractsGet(consultantPeriodId: string): Observable<ConsultantPeriodContractsDataDto> {
        let url_ = this.baseUrl + "/api/ConsultantPeriod/{consultantPeriodId}/contracts";
        if (consultantPeriodId === undefined || consultantPeriodId === null)
            throw new Error("The parameter 'consultantPeriodId' must be defined.");
        url_ = url_.replace("{consultantPeriodId}", encodeURIComponent("" + consultantPeriodId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processContractsGet(response: HttpResponseBase): Observable<ConsultantPeriodContractsDataDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    contractsPut(consultantPeriodId: string, body?: ConsultantPeriodContractsDataDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/ConsultantPeriod/{consultantPeriodId}/contracts";
        if (consultantPeriodId === undefined || consultantPeriodId === null)
            throw new Error("The parameter 'consultantPeriodId' must be defined.");
        url_ = url_.replace("{consultantPeriodId}", encodeURIComponent("" + consultantPeriodId));
